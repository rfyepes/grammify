...
export default function Menu({ showLogOut }) {
  ...
  return (
    ...
    <div className="menu">
      ...
      <Link to="/" className="home-button"><div className="title">SpotiGrammy</div></Link>
      <Link to="/" style={logOutStyle}>
    ...
    <div className="info-modal" onClick={(e) => {e.stopPropagation()}}>
      ...
      <div className="info-block">
        ...
        <div className="info-block-content">
          SpotiGrammy is a personalized version of the Grammy Awards based on your most-listened-to Spotify tracks, albums, and artists. SpotiGrammy creates a graphic showcasing nominees and a winner for each category: Song of the Year, Album of the Year, and Artist of the Year.
          <br />
          <br />
